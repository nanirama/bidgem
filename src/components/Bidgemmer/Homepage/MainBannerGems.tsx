...
const MainBannerGems = () => {
    ...
    return (
        <div className='img-gems-container'>
            ...
            <StaticImage src="../../../assets/images/bidgemmer/gems/gems-04.svg" loading='lazy' alt='image of a gem'
            ...
            <StaticImage src="../../../assets/images/bidgemmer/gems/gems-05.svg" loading='lazy' alt='image of a gem'
                     className='img-gems d-none d-xl-block ml-0 ml-md-2 ml-xl-5 mt-0 mt-md-2'
                     style={{
                         right: '25%',
                         top: '30rem',
            ...
            <ReactWOW delay='.25s' animation='fadeIn'>
            <StaticImage src="../../../assets/images/bidgemmer/gems/gems-03.svg" loading='lazy' alt='image of a gem'
